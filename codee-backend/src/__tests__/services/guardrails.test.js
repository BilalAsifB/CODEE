...
describe('Guardrails Service', () => {
  describe('validatePrompt', () => {
    test('should accept valid coding prompt', () => {
      const result = validatePrompt('Write a Python function to calculate factorial');
    ...
    test('should reject prompts without coding keywords', () => {
      const result = validatePrompt('Tell me about the weather today in New York');
      expect(result.valid).toBe(false);
  ...
  describe('quickValidatePrompt', () => {
    test('should return valid status for good prompt', () => {
      const result = quickValidatePrompt('Write a function to reverse a string');
      expect(result.valid).toBe(true);
  ...
  describe('checkUnsafeKeywords', () => {
    test('should allow safe content', () => {
      const result = checkUnsafeKeywords('Write a secure authentication function');
  ...
  describe('checkCodingRelevance', () => {
    test('should accept coding-related prompts', () => {
      const result = checkCodingRelevance('Write a Python script to parse JSON');
      expect(result.relevant).toBe(true);
    });

    test('should reject non-coding prompts', () => {
      const result = checkCodingRelevance('Tell me about the history of France');
    ...
    test('should accept prompts with programming language names', () => {
      const result = checkCodingRelevance('Create a React component for user authentication');
      expect(result.relevant).toBe(true);
    });

    test('should accept prompts with keywords like function, class, api', () => {
      const result = checkCodingRelevance('Build an API endpoint for user registration');
      expect(result.relevant).toBe(true);
    });
  ...
  describe('checkNonCodingContent', () => {
    test('should allow coding prompts', () => {
      const result = checkNonCodingContent('Write a function to calculate fibonacci');
      expect(result.allowed).toBe(true);
    });

    test('should reject recipe requests', () => {
      const result = checkNonCodingContent('Give me a recipe for chocolate cake');
